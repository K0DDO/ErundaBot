...
Несколько каналов на человека: ссылка `https://t.me/...`, `@channel` или invite `https://t.me/+...`. Название и картинка с t.me. Каналы **сгруппированы по владельцу** (все ТГК одного человека под одним разделителем, номера 1, 2, 3… подряд). Разделитель `--- {emoji} username ---` на всю ширину; превью — отдельной галереей под текстом. Если не влезает — несколько сообщений подряд.
